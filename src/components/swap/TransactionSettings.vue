<template>
  <div ref="settingsContainer" class="settings-container">
    <BaseButton class="settings-toggler" @click="toggleSettingsPopup">
      <img class="svg-image-to-white" src="" alt="settings icon" />
    </BaseButton>
    <div v-if="showSettingsPopup" class="settings-popup">
      <h5 class="settings-title"> Transaction Settings </h5>
      <div class="settings-item flex-wrap">
        ...
        <div class="item-field">
          <BaseButton variant="primary" rounded class="auto-button" @click="resetSlippageTolerance"
            >Auto</BaseButton
          >
          <BaseInput v-model="settings.slippageTolerance" class="field-input" placeholder="0.10" />
        </div>
      </div>
      <div class="settings-item flex-wrap">
        <h6 class="item-title">
      ...
      <h5 class="settings-title"> Interface Settings </h5>
      <div class="settings-item">
        ...
        <div class="item-field">
          <SwitchInput v-model="settings.autoRouter" size="small" />
        </div>
      </div>
      <div class="settings-item">
        <h6 class="item-title">
        ...
        <div class="item-field">
          <SwitchInput v-model="settings.expertMode" size="small" />
        </div>
      </div>
    </div>
  </div>
